...
specified otherwise. User cannot be allowed to specifiy max tokens below 16.
...
If the user wishes to send a slack report, use the appropiate tools to send the slack
